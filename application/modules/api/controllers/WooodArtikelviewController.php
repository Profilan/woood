<?php
class Api_WooodArtikelviewController extends Zend_Controller_Action
{
   ...
   public function indexAction()
    ...
    public function listAction()
    {
    	...
    	try {
        	...
        	Zend_Registry::get('logger')->info('WooodArtikelviewController: ' .__METHOD__. ' Total in query: ' . count($artikelViewList) );
    ...
    //    			unset($pakketArr['AANTAL_PAKKETTEN']);
        	...
        	Zend_Registry::get('logger')->info('WooodArtikelviewController: ' .__METHOD__. ' Total processed: ' . $totalProcessed );
    	} catch  (Exception $e) {
    	    $message = 'There was an error when the getting articles: '.$e->getMessage();
