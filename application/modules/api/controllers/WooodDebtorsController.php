<?php
class Api_WooodDebtorsController extends Zend_Controller_Action
{
	private $_WSDL_URI="https://is.woood.eu/api/woood-debtors?wsdl";
   ...
   public function indexAction()
    ...
    public function listAction()
    {
    	...
    	$debViewModel = new Site_Model_SQLWooodDebinfoList();
...
//     	}
    ...
    private function handleJson()
    {
    	...
    	$server->setClass('Site_Model_JsonRpcSQLWooodDebinfo');
    ...
    private function handleWSDL()
    {
    	...
    	$autodiscover->setClass('Site_Model_JsonRpcSQLWooodDebinfo');
    	$autodiscover->handle();
    }
