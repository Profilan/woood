...
/**
	...
	public function setAfmetingArtikelHxbxd($afmeting) {
		if (is_string($afmeting) || $afmeting == null) {
			$this->_afmetingArtikelHxbxd = $afmeting;
		} else {
