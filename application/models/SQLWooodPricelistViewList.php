...
class Site_Model_SQLWooodPricelistViewList
{
	/**
	...
	public function getMapper() {
		if (null === $this->_mapper) {
			$this->setMapper(new Site_Model_Db_SQLWooodPricelistViewMapper(new Site_Model_Db_SQLWooodPricelistViewDao()));
		}
		return $this->_mapper;
	}
	...
	public function getList($type = 'all', $key = null) {
		switch ($type) {
			case 'debiteur':
				$this->_articles = $this->getMapper()->fetchByDebiteur($key);
				break;
			case 'all' :
			default :
